...
ali = alibaba()
fp = open("data\\buyer.0.0", "r")
fr = fp.readline()
while fr != "":
    ali.addbuyer(fr)
    fr = fp.readline()
fp.close()
fp = open("data\\buyer.1.1", "r")
fr = fp.readline()
while fr != "":
    ali.addbuyer(fr)
    fr = fp.readline()
fp.close()
fp = open("data\\good.0.0", "r")
fr = fp.readline()
while fr != "":
    ali.addgood(fr)
    fr = fp.readline()
fp.close()
fp = open("data\\good.1.1", "r")
fr = fp.readline()
while fr != "":
    ali.addgood(fr)
    fr = fp.readline()
fp.close()
fp = open("data\\good.2.2", "r")
fr = fp.readline()
while fr != "":
    ali.addgood(fr)
    fr = fp.readline()
fp.close()
fp = open("data\\order.0.0", "r")
fr = fp.readline()
while fr != "":
    ali.addorder(fr)
    fr = fp.readline()
fp.close()
fp = open("data\\order.0.3", "r")
fr = fp.readline()
while fr != "":
    ali.addorder(fr)
    fr = fp.readline()
fp.close()
fp = open("data\\order.1.1", "r")
fr = fp.readline()
while fr != "":
    ali.addorder(fr)
    fr = fp.readline()
fp.close()
fp = open("data\\order.2.2", "r")
fr = fp.readline()
while fr != "":
    ali.addorder(fr)
    fr = fp.readline()
